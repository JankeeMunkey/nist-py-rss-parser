...
#Note: Need to run pip install feedparser
#Note: Error 'AttributeError: module 'feedparser' has no attribute '_HTMLSanitizer'' solved with running pip install feedparser==5.2.1
import feedparser
feedparser._HTMLSanitizer.acceptable_elements.update(['iframe'])

#TODO: import key_word list from results from a text file that was enumerated from an nmap scan to obtain keywords for software
